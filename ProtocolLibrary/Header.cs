...
namespace ProtocolLibrary
{
    public class Header
    {
        ...
        {
            return HeaderConstants.Request.Length + HeaderConstants.CommandLength + HeaderConstants.DataLength;
        }
        ...
        public byte[] GetResponse()
        {
            var header = new byte[GetLength()];
            Array.Copy(_direction, 0, header, 0, 3);
            Array.Copy(_command, 0, header, HeaderConstants.Response.Length, 2);
            Array.Copy(_dataLength, 0, header, HeaderConstants.Response.Length + HeaderConstants.CommandLength, 4);
            return header;
        }
